...
try:
    ...
    if not finalized_reports:
        ...
        report_data = ReportData(
            ...
            tabular_score=prediction.tabular_score,
            cnn_legibility=prediction.cnn_legibility,
            cnn_correctness=prediction.cnn_correctness,
            cnn_completeness=prediction.cnn_completeness,
            timeseries_score=prediction.timeseries_score,
            audio_score=prediction.audio_score,
            fused_score=prediction.fused_score,
            gradcam_image_path=f"src/edu_copilot/models/artifacts/{student.student_id}_gradcam.png",
            timeseries_attention_path=f"src/edu_copilot/models/artifacts/{student.student_id}_attention_ts.png",
            audio_attention_path=f"src/edu_copilot/models/artifacts/{student.student_id}_attention_audio.png",
